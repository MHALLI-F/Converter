...
SECRET_KEY = 'django-insecure-gj-x+3gt^3e!#m^vs+mhggoe7__+6ssmau)k2e_7&sn0y26kus'
...
DEFAULT_AUTO_FIELD = 'djaingo.db.models.BigAutoField'
...
CELERY_BEAT_SCHEDULE = {
                'task-number-one': {
                'task': 'json_to_csv.tasks.scheduledTask',
